...
def extract_best_domains(fasta_path, mads_tbl, kbox_tbl):
    ...
    SeqIO.write(mads_seqs, "Helianthus_MADS_Domains.fa", "fasta")
    SeqIO.write(kbox_seqs, "Helianthus_Kbox_Domains.fa", "fasta")
    print(f"Extracted {len(mads_seqs)} MADS and {len(kbox_seqs)} K-box unique best-hits.")

fasta = "Helianthus_annuuss_cleaned.fa"
mads_tbl = "/Users/bushrakhan/Desktop/NIPGR-data/NIPGR_WORK/Helianthus_annuuss/Helianthus_annuuss_MADS.domtblout"
kbox_tbl = "/Users/bushrakhan/Desktop/NIPGR-data/NIPGR_WORK/Helianthus_annuuss/Helianthus_annuuss_Kbox.domtblout"
