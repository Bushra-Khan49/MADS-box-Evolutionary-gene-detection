...
def extract_best_domains(fasta_path, mads_tbl, kbox_tbl):
    ...
    SeqIO.write(mads_seqs, "Medicago_MADS_Domains.fa", "fasta")
    SeqIO.write(kbox_seqs, "Medicago_Kbox_Domains.fa", "fasta")
    print(f"Extracted {len(mads_seqs)} MADS and {len(kbox_seqs)} K-box unique best-hits.")

fasta = "Medicago_truncatula_cleaned.fa"
mads_tbl = "/Users/bushrakhan/Desktop/NIPGR-data/NIPGR_WORK/Medicago_truncatula/Medicago_truncatula_MADS.domtblout"
kbox_tbl = "/Users/bushrakhan/Desktop/NIPGR-data/NIPGR_WORK/Medicago_truncatula/Medicago_truncatula_Kbox.domtblout"
