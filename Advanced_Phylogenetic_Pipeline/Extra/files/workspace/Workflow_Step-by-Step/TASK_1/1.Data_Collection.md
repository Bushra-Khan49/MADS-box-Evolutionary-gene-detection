...
- Make a list of all the files that are required.  
  **Examples:**
  1. Whole proteome file of ABCDE _Arabidopsis_ genes
      ...
      [Arabidopsis ABCDE whole proteome file](https://github.com/Bushra-Khan49/MADS-box-Evolutionary-gene-detection/tree/a7f7aa6a87c37bc795060e447d96a72b1ae09247/Workflow_Step-by-Step/TASK_1)  
  3. Whole proteome file of _Oryza sativa_ (rice)
     
      [Oryza whole proteome file](https://github.com/Bushra-Khan49/MADS-box-Evolutionary-gene-detection/tree/a71a7871e64e12d6c36c6f129f18ec6cc7550609/Workflow_Step-by-Step/TASK_1)  
  5. Pfam domain files for all MADS-box domains (Sourced from UniProt/InterPro)
     - PF00319 (MADS)
...
- **UniProt / InterPro** → primary source for protein domain HMM IDs (Pfam: PF00319, PF00847, PF01486)  
...
**f) Protein Domains (Sourced from UniProt)**  
...
- Pfam domains → `.hmm` (PF00319, PF01486, PF00847 sourced from UniProt)  
