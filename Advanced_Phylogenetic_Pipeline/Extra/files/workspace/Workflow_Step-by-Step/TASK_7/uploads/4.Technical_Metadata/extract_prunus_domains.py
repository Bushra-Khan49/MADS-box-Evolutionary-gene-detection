...
def extract_best_domains(fasta_path, mads_tbl, kbox_tbl):
    ...
    SeqIO.write(mads_seqs, "Prunus_MADS_Domains.fa", "fasta")
    SeqIO.write(kbox_seqs, "Prunus_Kbox_Domains.fa", "fasta")
    print(f"Extracted {len(mads_seqs)} MADS and {len(kbox_seqs)} K-box unique best-hits.")

fasta = "Prunus_persica_cleaned.fa"
mads_tbl = "/Users/bushrakhan/Desktop/NIPGR-data/NIPGR_WORK/Prunus_persica/Prunus_persica_MADS.domtblout"
kbox_tbl = "/Users/bushrakhan/Desktop/NIPGR-data/NIPGR_WORK/Prunus_persica/Prunus_persica_Kbox.domtblout"
