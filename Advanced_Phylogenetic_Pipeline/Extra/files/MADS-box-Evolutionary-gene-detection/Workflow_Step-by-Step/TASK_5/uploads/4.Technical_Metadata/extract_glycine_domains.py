...
def extract_best_domains(fasta_path, mads_tbl, kbox_tbl):
    ...
    SeqIO.write(mads_seqs, "Glycine_MADS_Domains.fa", "fasta")
    SeqIO.write(kbox_seqs, "Glycine_Kbox_Domains.fa", "fasta")
    print(f"Extracted {len(mads_seqs)} MADS and {len(kbox_seqs)} K-box unique best-hits.")

fasta = "Glycine_max_cleaned.fa"
mads_tbl = "/Users/bushrakhan/Desktop/NIPGR-data/NIPGR_WORK/Glycine_max/Glycine_max_MADS.domtblout"
kbox_tbl = "/Users/bushrakhan/Desktop/NIPGR-data/NIPGR_WORK/Glycine_max/Glycine_max_Kbox.domtblout"
