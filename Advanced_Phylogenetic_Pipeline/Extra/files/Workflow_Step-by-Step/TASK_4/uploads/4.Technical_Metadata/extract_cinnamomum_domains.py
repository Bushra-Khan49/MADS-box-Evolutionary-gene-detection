...
def extract_best_domains(fasta_path, mads_tbl, kbox_tbl):
    ...
    SeqIO.write(mads_seqs, "Cinnamomum_MADS_Domains.fa", "fasta")
    SeqIO.write(kbox_seqs, "Cinnamomum_Kbox_Domains.fa", "fasta")
    print(f"Extracted {len(mads_seqs)} MADS and {len(kbox_seqs)} K-box unique best-hits.")

fasta = "Cinnamomum_kanehirae_cleaned.fa"
mads_tbl = "/Users/bushrakhan/Desktop/NIPGR-data/NIPGR_WORK/Cinnamomum_kanehirae/Cinnamomum_kanehirae_MADS.domtblout"
kbox_tbl = "/Users/bushrakhan/Desktop/NIPGR-data/NIPGR_WORK/Cinnamomum_kanehirae/Cinnamomum_kanehirae_Kbox.domtblout"
